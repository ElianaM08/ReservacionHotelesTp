...
namespace ReservacionHoteles.Controllers
{
    public class ListaPrecioController : Controller
    {
        ...
        public ListaPrecioController(ReservacionHotelesContext context, IWebHostEnvironment webHostEnvironment)
        {
            _context = context;
        ...
        {
            var reservacionHotelesContext = _context.ListaPrecio.Include(l => l.CondicionPago);
        ...
        {
            ViewData["CondicionPagoRefId"] = new SelectList(_context.CondicionPago, "Id", "Descripcion");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Descripcion,FechaHasta,CondicionPagoRefId,Precio,FechaRegistro")] ListaPrecio listaPrecio)
        {
            ...
            ViewData["CondicionPagoRefId"] = new SelectList(_context.CondicionPago, "Id", "Descripcion", listaPrecio.CondicionPagoRefId);
            return View(listaPrecio);
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ReservacionHotelesContext.ListaPrecio'  is null.");
            }
            var listaPrecio = await _context.ListaPrecio.FindAsync(id);
            if (listaPrecio != null)
            {
        ...
        {
            var filepath = Path.Combine(_webHostEnvironment.WebRootPath, "Archivos", "ListaDePrecio.xlsx");
