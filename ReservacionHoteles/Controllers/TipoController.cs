...
namespace ReservacionHoteles.Controllers
{
    public class TipoController : Controller
    {
        ...
        public TipoController(ReservacionHotelesContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Tipo != null ? 
                          ...
                          Problem("Entity set 'ReservacionHotelesContext.Tipo'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ReservacionHotelesContext.Tipo'  is null.");
            }
            var tipo = await _context.Tipo.FindAsync(id);
            if (tipo != null)
            {
