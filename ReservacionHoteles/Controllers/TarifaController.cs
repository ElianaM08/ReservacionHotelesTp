...
namespace ReservacionHoteles.Controllers
{
    public class TarifaController : Controller
    {
        ...
        public TarifaController(ReservacionHotelesContext context)
        {
            _context = context;
        }
        ...
        {
            var reservacionHotelesContext = _context.Tarifa.Include(t => t.ListaPrecio);
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ReservacionHotelesContext.Tarifa'  is null.");
            }
            var tarifa = await _context.Tarifa.FindAsync(id);
            if (tarifa != null)
            {
