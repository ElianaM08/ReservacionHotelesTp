...
namespace ReservacionHoteles.Controllers
{
    public class CondicionPagoController : Controller
    {
        ...
        public CondicionPagoController(ReservacionHotelesContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.CondicionPago != null ? 
                          ...
                          Problem("Entity set 'ReservacionHotelesContext.CondicionPago'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ReservacionHotelesContext.CondicionPago'  is null.");
            }
            var condicionPago = await _context.CondicionPago.FindAsync(id);
            if (condicionPago != null)
            {
